"""
================================================================================
Prospect — FastAPI Application Entry Point
================================================================================
File:     server/main.py

HOW TO RUN
----------
    cd /Users/louisconstant/skintlabs/Prospect
...
logger = logging.getLogger("prospect.main")
...
async def lifespan(app: FastAPI):
    ...
    logger.info(
        f"Prospect API started | env={settings.environment} | "
    ...
    logger.info("Prospect API shutdown complete.")
...
if __name__ == "__main__":
    logger.info(
        f"Starting Prospect API | environment={settings.environment} | port={settings.port}"
    )
    uvicorn.run(
        "server.main:app",
        host="0.0.0.0",
