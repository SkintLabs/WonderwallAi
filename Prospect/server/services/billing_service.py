"""
Prospect — Billing Service
Manages Stripe subscriptions for Prospect users.
"""
...
logger = logging.getLogger("prospect.billing")
...
class BillingService:
    """Manages Stripe subscriptions and billing events for Prospect users."""
